...
function sendApiRequest(searched) {
  
    fetch("https://api.giphy.com/v1/gifs/search?api_key=l5yR6zuIrJZJB48hFmb6E6G8fCu6b3pQ&q="+searched+"&limit=25&offset=0&rating=G&lang=en")
    .then(function(data) {
      return data.json();
    })
    .then(function(json) {
